...
def save(fig,name):
    for ext in ['png','svg','pdf']:
        ...
        fig.savefig(pending,dpi=220,bbox_inches='tight',pad_inches=.12)
        if ext=='svg':
...
save(fig,'roi_scene')
print('Generated 4 diagrams in PNG, SVG and PDF.')
